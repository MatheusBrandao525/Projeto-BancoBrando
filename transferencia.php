		...
		<div class="menulateral centrogrid">
			...
			<ul class="ulmenu">
				...
				<div class="centro padtop">
					<a href="" class="linkbool">
						<div class="bool centro"><i class="fa fa-facebook-square icon" aria-hidden="true"></i></div>
					</a>
					<a href="" class="linkbool">
						<div class="bool centro"><i class="fa fa-linkedin-square icon" aria-hidden="true"></i></div>
					</a>
					<a href="" class="linkbool">
						<div class="bool centro"><i class="fa fa-instagram icon" aria-hidden="true"></i></div>
					</a>
				</div>
			</ul>
		</div>
...
<script>
	$(function() {
		let codigo_banco = sessionStorage.getItem('banco');
		let agencia = sessionStorage.getItem('agencia');
		let valorTed = sessionStorage.getItem('valor');
		let numeroConta = sessionStorage.getItem('conta');
		let selectConta = sessionStorage.getItem('selectConta');

		$('#bancoTed').val(codigo_banco);
		$('#agenciaTed').val(agencia);
		$('#valorTed').val(valorTed);
		$('#numerocontaTed').val(numeroConta);
		$('#selecao').val(selectConta);
