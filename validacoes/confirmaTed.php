...
<script>
    $(function() {
        $('#cancelaTed').click(function() {
            ...
            sessionStorage.setItem('selectConta', '<?= $selectConta; ?>');
            sessionStorage.setItem('valor', '<?= $valorTed ?>');
            sessionStorage.setItem('banco', '<?= $cod_banco ?>');
            sessionStorage.setItem('agencia', '<?= $agencia ?>');
            sessionStorage.setItem('conta', '<?= $numeroConta ?>');
